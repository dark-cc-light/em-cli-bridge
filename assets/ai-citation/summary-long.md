...
- **Adaptable.** Devices without unlock, with different encodings, or with different command sets are supported by editing four constants and the command table.
